...
DROP CONSTRAINT SYS_C0012411; -- אם יש קשר חוץ שלא ידוע לי מה זה.
...
ALTER TABLE TEAMP
DROP CONSTRAINT SYS_C0012400;

ALTER TABLE ACTIN
DROP CONSTRAINT SYS_C0012404; 
